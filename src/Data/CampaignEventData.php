...
final class CampaignEventData extends Data
{
    /**
     * @param  array<string, mixed>  $campaign
     * @param  array<string, mixed>  $program
     * @param  array<string, mixed>  $beneficiaryList
    ...
    {
        return new self(
            eventType: self::stringValue($data['event_type'] ?? 'campaign.event.recorded', 'campaign.event.recorded'),
            ...
            campaign: self::arrayValue($data['campaign'] ?? []),
            program: self::arrayValue($data['program'] ?? []),
            beneficiaryList: self::arrayValue($data['beneficiary_list'] ?? []),
            distribution: self::arrayValue($data['distribution'] ?? []),
            batch: self::arrayValue($data['batch'] ?? []),
    ...
    public function eventPayload(): array
    {
        return array_replace([
            ...
            'beneficiary_list' => $this->beneficiaryList,
