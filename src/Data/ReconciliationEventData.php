...
final class ReconciliationEventData extends Data
{
    /**
    ...
    {
        return new self(
            eventType: self::stringValue($data['event_type'] ?? 'reconciliation.comparison.recorded', 'reconciliation.comparison.recorded'),
            ...
            expected: self::arrayValue($data['expected'] ?? []),
            actual: self::arrayValue($data['actual'] ?? []),
            comparison: self::arrayValue($data['comparison'] ?? []),
